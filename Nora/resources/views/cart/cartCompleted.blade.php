        ...
        <div class="row g-0 flex-nowrap">
            <div class="col">
                <div class="d-grid menu-button-left" role="group" aria-label="Basic example">
                    <a href="/categoryPage" type="button" class="btn btn-secondary menu-buttons our-buttons">Hry</a>
                </div>
            </div>
            <div class="col">
                <div class="d-grid" role="group" aria-label="Basic example">
                    <a href="/categoryPage" type="button" class="btn btn-secondary menu-buttons our-buttons">Konzoly</a>
                </div>
            </div>
            <div class="col">
                <div class="d-grid" role="group" aria-label="Basic example">
                    <a href="/categoryPage" type="button" class="btn btn-secondary menu-buttons our-buttons">Merch</a>
                </div>
            </div>
            <div class="col">
                <div class="d-grid" role="group" aria-label="Basic example">
                    <a href="/categoryPage" type="button" class="btn btn-secondary menu-buttons our-buttons">Figúrky</a>
                </div>
            </div>
            <div class="col">
